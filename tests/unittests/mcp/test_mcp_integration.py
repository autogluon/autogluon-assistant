...
M,0.615,0.455,0.13,0.9685,0.49,0.182,0.2655,10"""
        ...
        print(f"Created train.csv with small dataset")
        ...
        async def run_test():
            ...
            try:
                async with Client(mcp_url) as client:
                    ...
                    assert len(result) > 0, "Empty response from MCP client"
                    ...
                    print(f"✓ Found logs.txt")
                    
                    # Check generation_iter_0 directory
                    gen_iter_dir = mlzero_dir / "generation_iter_0"
                    assert gen_iter_dir.exists() and gen_iter_dir.is_dir(), f"generation_iter_0 directory not found in {mlzero_dir}"
                    print(f"✓ Found generation_iter_0 directory")
