...
SCRIPT_ROOT="/media/agent/AutoMLAgent/tools/auto2ml_best"
...
PREGENERATED_CODE="${SCRIPT_ROOT}/${DATASET_NAME}/generated_code.py"
...
echo "Running script for dataset: $DATASET_NAME"
