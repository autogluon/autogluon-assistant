...
codex -q -a full-auto "Solve the ml task described in folder ${TRAINING_PATH}. Do not modify any files in ${TRAINING_PATH}. All temp or saved files should be located somewhere under ${OUTPUT_DIR}. Save the predicted results to ${OUTPUT_DIR}, result file name should be \"results\", the format and extension should be same as the test data file."
